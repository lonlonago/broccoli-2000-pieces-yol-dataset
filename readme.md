# Broccoli (2000 pieces) YOL dataset

# Body

Broccoli (2000) YOL dataset， clear images, complete annotations, suitable for target detection model training, ready to use, saves time and effort

The dataset contains a large number of broccoli images, labeled, supports YOLO format, and is convenient for training models. It is suitable for scenarios such as vegetable detection and food recognition.
